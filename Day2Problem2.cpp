...
character in s. For example, if s = "dcce" then f(s) = 2 because the smallest character is "c" and its 
frequency is 2.

Now, given string array as queries and words, return an integer array answer, where each answer[i] is 
